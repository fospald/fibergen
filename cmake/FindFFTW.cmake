...
#   OPTION(FFTWD_LIB "The full path to the fftw3 library (including the library)" )
    ...
    IF(FFTWL_LIB)
      message(STATUS "FFTW (long double precision) library found.")
      SET(FFTWL_FOUND 1)
      IF(FFTWL_THREADS_LIB)
        SET(FFTWL_LIB ${FFTWL_LIB} ${FFTWL_THREADS_LIB} )
      ENDIF(FFTWL_THREADS_LIB)
    ELSE()
      if(FFTWL_FIND_REQUIRED)
        message(FATAL_ERROR "FFTW (long double precision) library not found.")
      else()
        message(STATUS "FFTW (long double precision) library not found.")
      endif()
    ENDIF()
  ENDIF(USE_FFTWL)
...
#   OPTION(FFTWF_LIB "The full path to the fftw3f library (including the library)" )
    ...
    IF(FFTWF_LIB)
      message(STATUS "FFTW (single precision) library found.")
      SET(FFTWF_FOUND 1)
    ...
    ELSE()
      if(FFTWF_FIND_REQUIRED)
        ...
        message(STATUS "FFTW (single precision) library not found.")
      endif()
    ENDIF()
  ENDIF(USE_FFTWF)

ENDIF(USE_FFTWL OR USE_FFTWD OR USE_FFTWF)
